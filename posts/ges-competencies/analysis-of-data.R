url <- "https://www.gov.uk/government/publications/ges-technical-framework-2022/2-analysis-of-data"
req <- httr::GET(url)
...
content <- c(content[1:32], 
     "Generally well placed to identify opportunities for econometric analysis and carry it out depending on previous academic and work training.",
     content[33:41])
...
write.csv(tbl, "posts/ges-competencies/analysis-of-data.csv", row.names = FALSE)
