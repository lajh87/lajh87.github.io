url <- "https://www.gov.uk/government/publications/ges-technical-framework-2022/3-effective-communication"
...
write.csv(tbl, "posts/ges-competencies/effective-communication.csv", row.names = FALSE)
